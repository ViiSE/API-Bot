...
@Scope("prototype")
public class DeleteRequestImpl implements Request {
    ...
    public Response execute() throws RequestException {
        ...
        try {
            ...
            okhttp3.Request request = builder.delete(rBody).build();
            ...
            return responseProducer.getDeleteResponseWithUrlInstance(url);
